...
% Set initial and final velocities and accelerations to zero
wi0 = [0; 0; 0; 0; 0]; % Initial velocities
wif = [0; 0; 0; 0; 0]; % Final velocities
ai0 = [0; 0; 0; 0; 0]; % Initial accelerations
aif = [0; 0; 0; 0; 0]; % Final accelerations

% Quintic polynomial matrix for boundary conditions
...
for i = 1:5
    ...
    B = [qi0(i); qif(i); wi0(i); wif(i); ai0(i); aif(i)];
    
    % Solve for polynomial coefficients [a0; a1; a2; a3; a4; a5]
    a = A\B;
    
    % Calculate position, velocity, and acceleration
    q(i, :) = a(1) + a(2)*t + a(3)*t.^2 + a(4)*t.^3 + a(5)*t.^4 + a(6)*t.^5;    % Position
    qd(i, :) = a(2) + 2*a(3)*t + 3*a(4)*t.^2 + 4*a(5)*t.^3 + 5*a(6)*t.^4;      % Velocity
    qdd(i, :) = 2*a(3) + 6*a(4)*t + 12*a(5)*t.^2 + 20*a(6)*t.^3;                % Acceleration
end
